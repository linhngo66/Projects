...
SELECT DISTINCT(Pickup_point), COUNT(Request_id) 
FROM uberrequest
GROUP BY Pickup_point;

SELECT DISTINCT(Pickup_point), Time_of_day, COUNT(Request_id) 
FROM uberrequest
...
SELECT CTE.Driver_id, u.Pickup_point, COUNT(u.Request_id) 
FROM CTE
...
With CTE AS(
    ...
    GROUP BY Driver_id
    ORDER BY COUNT(Request_id) DESC LIMIT 3)
SELECT CTE.Driver_id, u.Status, COUNT(u.Status) 
FROM CTE
